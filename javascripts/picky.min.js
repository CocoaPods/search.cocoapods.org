...
this.allocationChosen=function(c){f(c)};this.addinationClicked=function(c,q){f(c,{offset:q.data.offset})};window.History&&window.History.Adapter.bind(window,"statechange",function(){var c=window.History.getState();(c=y(c.url))&&c!=(x.length>1&&x[1])&&u(c)})};var Localization={},PickyI18n={};$(function(){PickyI18n.locale=$("html").attr("lang").split("-")[0]||"en"});
