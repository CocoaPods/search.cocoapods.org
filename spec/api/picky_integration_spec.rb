...
describe 'Integration Tests' do
  ...
  #
  ok do
    names_for_search('on:ios mettt~', sort: 'name').should == %w(AFIncrementalStore AFNetworking AFOAuth2Client CargoBay FormatterKit GroundControl TTTAttributedLabel)
  end
  ...
  #
  expected = %w(AFNetworking AFIncrementalStore AFOAuth2Client AFIncrementalStore AFOAuth2Client CargoBay GroundControl)
