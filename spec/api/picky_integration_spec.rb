...
describe 'Integration Tests' do
  ...
  #
  ok do
    pods.search('on:osx ki', sort: 'name').ids.should == [1282, 819, 3836, 2158, 372, 3829, 30, 554, 3783, 5107, 4939, 3753, 614, 4552, 3113, 4940, 2108, 3404, 2908, 2322]
  ...
  #
  ok do
    pods.search('on:ios allan~', sort: 'name').ids.should == [3163, 267, 2520, 1105, 2554, 2756, 5391, 13, 4847]
