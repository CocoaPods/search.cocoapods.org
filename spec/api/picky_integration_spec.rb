...
describe 'Integration Tests' do
  ...
  ok { pods.search('on:ios adjust').entries.should == [{:id=>"RDHDateAdjustment", :platforms=>["ios", "osx"], :version=>"1.0.0", :summary=>"Categories on NSDate to simplify date adjustment.", :authors=>"Rich Hodgkins", :link=>"https://github.com/rhodgkins/RDHDateAdjustment", :source=>{:git=>"https://github.com/rhodgkins/RDHDateAdjustment.git", :tag=>"1.0.0"}, :subspecs=>[], :tags=>[], :deprecated=>false, :deprecated_in_favor_of=>nil}, {:id=>"LHSKeyboardAdjusting", :platforms=>["ios"], :version=>"0.0.1", :summary=>"An easy-to-use utility that will automatically resize views whenever a keyboard appears", :authors=>{:"Dan Loewenherz"=>"dan@lionheartsw.com"}, :link=>"http://lionheartsw.com/", :source=>{:git=>"https://github.com/lionheart/LHSKeyboardAdjusting.git", :tag=>"0.0.1"}, :subspecs=>[], :tags=>["view"], :deprecated=>false, :deprecated_in_favor_of=>nil}, {:id=>"ESAdjustableLabel-Category", :platforms=>["ios"], :version=>"0.0.1", :summary=>"This category implements some basic methods to modify the dimensions of a given UILabel.", :authors=>{:"Edgar Schmidt"=>"https://github.com/edgarschmidt"}, :link=>"https://github.com/edgarschmidt/ESAdjustableLabel-Category", :source=>{:git=>"https://github.com/edgarschmidt/ESAdjustableLabel-Category", :commit=>"febfd4d4e3d18f6dfac0637449bdb13a3c89fc04"}, :subspecs=>[], :tags=>[], :deprecated=>false, :deprecated_in_favor_of=>nil}, {:id=>"CXAdjustBlockView", :platforms=>["ios"], :version=>"1.1.0", :summary=>"CXAdjustBlockView(UIScrollView).", :authors=>{:ChrisXu=>"taterctl@gmail.com"}, :link=>"https://github.com/ChrisXu1221/CXAdjustBlockView", :source=>{:git=>"https://github.com/ChrisXu1221/CXAdjustBlockView.git", :tag=>"1.1.0"}, :subspecs=>[], :tags=>[], :deprecated=>false, :deprecated_in_favor_of=>nil}, {:id=>"AdjustIo", :platforms=>["ios"], :version=>"2.0", :summary=>"This is the iOS SDK of AdjustIo. You can read more about it at http://adjust.io.", :authors=>{:"Christian Wellenbrock"=>"welle@adeven.com"}, :link=>"http://adjust.io", :source=>{:git=>"https://github.com/adeven/adjust_ios_sdk.git", :tag=>"v2.0"}, :subspecs=>[], :tags=>["http"], :deprecated=>false, :deprecated_in_favor_of=>nil}, {:id=>"AdjustIO", :platforms=>["ios"], :version=>"2.2.0", :summary=>"This is the iOS SDK of AdjustIo. You can read more about it at http://adjust.io.", :authors=>{:"Christian Wellenbrock"=>"welle@adeven.com"}, :link=>"http://adjust.io", :source=>{:git=>"https://github.com/adeven/adjust_ios_sdk.git", :tag=>"v2.2.0"}, :subspecs=>[], :tags=>["http"], :deprecated=>false, :deprecated_in_favor_of=>nil}, {:id=>"Adjust", :platforms=>["ios"], :version=>"3.3.3", :summary=>"This is the iOS SDK of Adjust. You can read more about it at http://adjust.io.", :authors=>{:"Christian Wellenbrock"=>"welle@adjust.com"}, :link=>"http://adjust.io", :source=>{:git=>"https://github.com/adeven/adjust_ios_sdk.git", :tag=>"v3.3.3"}, :subspecs=>[], :tags=>["http"], :deprecated=>false, :deprecated_in_favor_of=>nil}, {:id=>"Tweaks", :platforms=>["ios"], :version=>"1.1.0", :summary=>"Easily adjust parameters for iOS apps in development.", :authors=>{:"Grant Paul"=>"tweaks@grantpaul.com", :"Kimon Tsinteris"=>"kimon@mac.com"}, :link=>"https://github.com/facebook/Tweaks", :source=>{:git=>"https://github.com/facebook/Tweaks.git", :tag=>"1.1.0"}, :subspecs=>[], :tags=>[], :deprecated=>false, :deprecated_in_favor_of=>nil}, {:id=>"LumberjackConsole", :platforms=>["ios"], :version=>"2.0.2", :summary=>"On-device CocoaLumberjack console with support for search, adjust levels, copying and more.", :authors=>{:"Ernesto Rivera"=>"rivera.ernesto@gmail.com"}, :link=>"http://ptez.github.io/LumberjackConsole", :source=>{:git=>"https://github.com/PTEz/LumberjackConsole.git", :tag=>"2.0.2"}, :subspecs=>[], :tags=>[], :deprecated=>false, :deprecated_in_favor_of=>nil}, {:id=>"Adjust", :platforms=>["ios"], :version=>"3.3.3", :summary=>"This is the iOS SDK of Adjust. You can read more about it at http://adjust.io.", :authors=>{:"Christian Wellenbrock"=>"welle@adjust.com"}, :link=>"http://adjust.io", :source=>{:git=>"https://github.com/adeven/adjust_ios_sdk.git", :tag=>"v3.3.3"}, :subspecs=>[], :tags=>["http"], :deprecated=>false, :deprecated_in_favor_of=>nil}] }
  ...
  ok { pods.search('kiwi allen ding').entries.should == [{:id=>"Kiwi", :platforms=>["ios", "osx"], :version=>"2.2.4", :summary=>"A Behavior Driven Development library for iOS and OS X.", :authors=>{:"Allen Ding"=>"alding@gmail.com", :"Luke Redpath"=>"luke@lukeredpath.co.uk", :"Marin Usalj"=>"mneorr@gmail.com", :"Stepan Hruda"=>"stepan.hruda@gmail.com"}, :link=>"https://github.com/allending/Kiwi", :source=>{:git=>"https://github.com/allending/Kiwi.git", :tag=>"2.2.4"}, :subspecs=>[], :tags=>[], :deprecated=>false, :deprecated_in_favor_of=>nil}] }
