...
describe 'Integration Tests' do
  ...
  ok { names_for_search('author:mattt author:thompson', sort: 'name').should == ["AFCoreImageResponseSerializer", "AFHTTPRequestOperationLogger", "AFIncrementalStore", "AFJSONRPCClient", "AFKissXMLRequestOperation", "AFKissXMLRequestOperation@aceontech", "AFMsgPackSerialization", "AFNetworkActivityLogger", "AFNetworking"] }
  ok { names_for_search('authors:mattt authors:thompson', sort: 'name').should == ["AFCoreImageResponseSerializer", "AFHTTPRequestOperationLogger", "AFIncrementalStore", "AFJSONRPCClient", "AFKissXMLRequestOperation", "AFKissXMLRequestOperation@aceontech", "AFMsgPackSerialization", "AFNetworkActivityLogger", "AFNetworking"] }
  ok { names_for_search('written:mattt written:thompson', sort: 'name').should == ["AFCoreImageResponseSerializer", "AFHTTPRequestOperationLogger", "AFIncrementalStore", "AFJSONRPCClient", "AFKissXMLRequestOperation", "AFKissXMLRequestOperation@aceontech", "AFMsgPackSerialization", "AFNetworkActivityLogger", "AFNetworking"] }
  ok { names_for_search('writer:mattt writer:thompson', sort: 'name').should == ["AFCoreImageResponseSerializer", "AFHTTPRequestOperationLogger", "AFIncrementalStore", "AFJSONRPCClient", "AFKissXMLRequestOperation", "AFKissXMLRequestOperation@aceontech", "AFMsgPackSerialization", "AFNetworkActivityLogger", "AFNetworking"] }
